...
> [Apache 软件基金会（ASF）](https://www.apache.org/) 为开源项目提供基础设施，捐赠的法律实体，Apache商标保护，法律保护框架，开源项目治理及指导的服务。
> ASF 这是一个由志愿者组成的，面向全球的虚拟化组织， 大家以个人身份参与到基金会的运作过程中，通过贡献来赢得社群的信任。ASF 使命： 为公众免费提供开源软件。
> 目前 ASF 基金会会员 800+，Committer 8000+， 监管 350 多个开源项目，其中包括 Apache HTTP Server（全球应用最广泛的网站服务器软件）、Apache Hadoop 大数据分析平台以及 Apache Tomcat（Java 应用服务器）。这些开源项目都是采用 Apache 许可证发行的。
